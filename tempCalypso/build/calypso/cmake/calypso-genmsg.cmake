...
message(STATUS "calypso: 2 messages, 0 services")

set(MSG_I_FLAGS "-Icalypso:/home/mahmoudtarek02/tempCalypso/src/calypso/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/mahmoudtarek02/tempCalypso/src/calypso/msg/mapMessage.msg" NAME_WE)
add_custom_target(_calypso_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "calypso" "/home/mahmoudtarek02/tempCalypso/src/calypso/msg/mapMessage.msg" ""
)

get_filename_component(_filename "/home/mahmoudtarek02/tempCalypso/src/calypso/msg/joystick.msg" NAME_WE)
add_custom_target(_calypso_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "calypso" "/home/mahmoudtarek02/tempCalypso/src/calypso/msg/joystick.msg" ""
)
